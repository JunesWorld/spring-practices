package com.junesworld.logex3.controller;
...
public class ExampleController3 {
	...
	public String ex3() {
		 ...
		 *  
		 *  1. fileAppender3 와 "com.junesworld.logex3" logger 를 살펴 보아야 합니다.
		 *  
		 ...
		 *    
		 *  4. 새로운 로거를 세팅하고 있습니다.
		 *     "com.junesworld.logex3" 로거인데, 콘솔과 파일로 로그를 남기고 있는 것을 확인해야
		 *     합니다.
		 *     
